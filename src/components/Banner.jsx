    ...
    <div className='p-4 max-w-[1640px] mx-auto'>
      <div className='max-h-[600px] relative'>
        <div className='absolute w-full h-full text-papaswhite max-h-[600px] bg-papasblack/70 flex flex-col justify-center'>
          <h1 className='p-8 px-8 text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold'>Looking for a<ReactTyped className='p-8 px-4 text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold' strings={['Pizza?', 'Sensation?', 'Flavor?']} typeSpeed={80} backSpeed={100} loop/></h1>
