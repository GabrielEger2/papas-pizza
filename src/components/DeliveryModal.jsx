                            ...
                            <div className="p-6 space-y-6">
                                <div className="w-96 h-[60vh] text-papasblack">
                                    ...
                                    <div>
                                        ...
                                        <div className="items-center flex mt-8 text-gray-700 border border-gray-300 rounded-2xl bg-gray-100 p-2">
                                    ...
                                    <div>
                                        ...
                                        <form>   
                                            ...
                                            <div class="relative">
                                                ...
                                                <input 
                                                class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 mt-4" 
